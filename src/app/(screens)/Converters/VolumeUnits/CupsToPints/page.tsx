...
import ConversionTable from "./ConversionTable"; // You will create a table adjusted for Cups to Pints
...
const CupsToPintsPage = () => {
  return (
    <ReusableConversionPage
      title="Convert Cups to Pints"
      fromUnit="Cups (US cup)"
      toUnit="Pints (US pt)"
      convertFunction={(val) => val / 2} // 1 pint = 2 cups → cups ÷ 2 = pints
      ...
      conversionExample={
        <>
          1 pint = 2 cups
          <br />
          <strong>Example:</strong> convert 6 cups to pints:
          <br />6 ÷ 2 = 3 pints
        </>
      }
      reversePath="/Converters/VolumeUnits/PintsToCups"
    />
  );
};

export default CupsToPintsPage;
