...
import ConversionTable from "./ConversionTable"; // Adjust this ConversionTable for Pints to Gallons
...
const PintsToGallonsPage = () => {
  return (
    <ReusableConversionPage
      title="Convert Pints to Gallons"
      ...
      conversionExample={
        <>
          1 gallon = 8 pints
          <br />
          <strong>Example:</strong> convert 16 pints to gallons:
          <br />
          16 ÷ 8 = 2 gallons
        </>
      }
      reversePath="/Converters/VolumeUnits/GallonsToPints"
    />
  );
};

export default PintsToGallonsPage;
