...
const page = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() => router.push("/Converters/WeightAndMass/GramsToOunces")}
            >
              ↕
            </span>
          </div>
      ...
      <p>
        1 oz = 28.349523125 g
        <br />1 g = 0.0352739619 oz
      </p>
      <p>
        <strong>Example: </strong>convert 15 oz to g :
        <br />
        15 oz = 15 × 28.349523125 g = 425.242846875 g
      </p>
    </div>
  );
};
