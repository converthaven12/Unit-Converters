  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() => router.push("/Converters/WeightAndMass/GramToKg")}
            >
              ↕
            </span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sm:gap-4">
          <div className="space-y-4 w-full">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-[#006633]">kilogram</span>
            </div>
      ...
      <section className="space-y-3 text-justify">
        ...
        <p>
          <strong>Current use:</strong> The gram is widely used in many
          applications, especially in cooking and food labeling, where it is
          common to measure ingredients in grams. It is also used in scientific
          contexts, such as chemistry and physics, where precise measurements of
          mass are required.
        </p>
      </section>
      ...
      <p>
        <strong>Example: </strong>convert 15 kg to g :
        <br />
