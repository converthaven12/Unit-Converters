...
const page = () => {
  ...
  return (
    <div className="min-h-screen">
      <h1 className="font-bold text-4xl text-[#006633]">Convert kg to oz</h1>
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() => router.push("/Converters/WeightAndMass/OzToKg")}
            >
              ↕
            </span>
          </div>
      ...
      <p>
        ...
        <br />1 oz = 0.0283495231 kg
      </p>
      <p>
        <strong>Example: </strong>convert 15 kg to oz :
        <br />
