...
const page = () => {
  ...
  const convert = () => {
    ...
    if (!isNaN(value)) {
      const stones = value * 0.08;
      setToValue(stones.toFixed(4));
    }
  };
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() =>
                router.push("/Converters/WeightAndMass/StoneToLbs")
              }
            >
              ↕
            </span>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sm:gap-4">
          <div className="space-y-4 w-full">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-[#006633]">Stone (US)</span>
            </div>
          </div>
      ...
      <p>
        1 lbs = 0.08 stone (US)
        <br />1 stone (US) = 12.5 lbs
      </p>
      <p>
        <strong>Example: </strong>convert 15 lbs to stone (US) :
        <br />
