...
import ConversionTable from "./ConversionTable"; // Adjust this table for Hectares to Acres
...
const HectareToAcresPage = () => {
  return (
    <ReusableConversionPage
      title="Convert Hectares to Acres"
      fromUnit="Hectares"
      toUnit="Acres"
      convertFunction={(val) => val * 2.47105381} // 1 hectare = 2.47105381 acres
      ...
      conversionExample={
        <>
          ...
          <br />
          <strong>Example:</strong> convert 10 hectares to acres:
          <br />
...
export default HectareToAcresPage;
