...
const page = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() =>
                router.push("/Converters/CommonConversions/DegreesToRadians")
              }
            >
              ↕
            </span>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sm:gap-4">
          <div className="space-y-4 w-full">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-[#006633]">radian</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-[#006633]">degree</span>
            </div>
          </div>
      ...
      <p>
        1 rad = 57.2957795131 °
        <br />1 ° = 0.0174532925 rad
      </p>
      <p>
        <strong>Example: </strong> convert 15 rad to ° :
        <br />
        15 rad = 15 × 57.2957795131 ° = 859.4366926962 °
      </p>
    </div>
  );
};
