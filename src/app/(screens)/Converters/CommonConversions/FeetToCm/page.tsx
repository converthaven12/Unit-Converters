...
const page = () => {
  ...
  return (
    <div className="min-h-screen">
      <h1 className="font-bold text-4xl text-[#006633]">Convert feet to cm</h1>
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() =>
                router.push("/Converters/CommonConversions/CmToFeet")
              }
            >
              ↕
            </span>
      ...
      <p>
        1 ft = 30.48 cm
        <br />1 cm = 0.032808399 ft
      </p>
      <p>
        <strong>Example: </strong>convert 15 ft to cm :
        <br />
