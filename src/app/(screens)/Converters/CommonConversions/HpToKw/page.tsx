...
const page = () => {
  ...
  const convert = () => {
    ...
    if (!isNaN(value)) {
      const kilowatts = value * 0.7457;
      setToValue(kilowatts.toFixed(4));
    }
  };
  ...
  return (
    <div className="min-h-screen">
      <h1 className="font-bold text-4xl text-[#006633]">Convert hp to kw</h1>
        ...
        <div className="flex justify-between items-center sm:gap-0 -gap-x-1">
          ...
          <div className="cursor-pointer">
            <span
              ...
              onClick={() =>
                router.push("/Converters/CommonConversions/KwToHp")
              }
            >
              ↕
            </span>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 sm:gap-4">
          <div className="space-y-4 w-full">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-[#006633]">kilowatt</span>
            </div>
          </div>
      ...
      {/* Section 4 */}
      <h1 className="text-xl text-[#006633] font-semibold mt-10">
        How to Convert Horsepower (metric) to Kilowatt
      </h1>
      <p>
        1 horsepower (metric) = 0.73549875 kW
        <br />1 kW = 1.3596216173 horsepower (metric)
      </p>
      <p>
        <strong>Example: </strong>convert 15 horsepower (metric) to kW :
        <br />
