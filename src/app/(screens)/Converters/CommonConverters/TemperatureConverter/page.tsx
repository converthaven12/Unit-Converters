...
const temperatureUnits = ["Celsius", "Fahrenheit", "Kelvin", "Rankine", "Delisle", "Newton", "Réaumur", "Rømer"];
...
const convertTemperature = (value: number, from: string, to: string): number => {
  ...
  switch (from) {
    ...
    case "Réaumur": celsius = value * 5 / 4; break;
    case "Rømer": celsius = (value - 7.5) * 40 / 21; break;
    default: return NaN;
  }
  ...
  switch (to) {
    ...
    case "Rømer": return celsius * 21 / 40 + 7.5;
    default: return NaN;
  }
};
