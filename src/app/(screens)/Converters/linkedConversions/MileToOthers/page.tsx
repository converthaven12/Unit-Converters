...
const MileToAllPage = () => {
  const jsonLd = {
    ...
    "@type": "WebPage",
    "name": "Miles to All Units Converter",
    "description": "Convert miles to meters, kilometers, yards, inches, nautical miles, and more with this easy online unit converter.",
    "url": "https://www.converthaven.com/Converters/linkedConversions/MileToOthers"
  };

  return (
    <>
      <Head>
        <title>Miles to All Units Converter | Convert Mile to Others</title>
        <meta
          name="description"
          content="Convert miles to meters, kilometers, yards, inches, nautical miles, and more with this easy online unit converter."
        />
        <link
          rel="canonical"
          href="https://www.converthaven.com/Converters/linkedConversions/MileToOthers"
        />
        <script
