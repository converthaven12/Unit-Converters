...
const FeetToMillimetersPage = () => {
  return (
    <ReusableConversionPage
      title="Convert Feet to Millimeters"
      fromUnit="Feet"
      toUnit="Millimeters"
      convertFunction={(val) => val * 304.8} // 1 ft = 304.8 mm
      ...
      conversionExample={
        <>
          ...
          1 mm = 0.003281 ft
          <br />
          <strong>Example:</strong> convert 6.5 ft to mm:
          <br />
          6.5 ft × 304.8 = 1,981.2 mm
        </>
      }
      reversePath="/Converters/LengthUnits/MillimetersToFeet"
    />
  );
};

export default FeetToMillimetersPage;
