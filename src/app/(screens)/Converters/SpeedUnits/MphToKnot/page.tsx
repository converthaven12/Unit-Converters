...
import ConversionTable from "./ConversionTable"; // This will show mph to knots
...
const MilesPerHourToKnotPage = () => {
  return (
    <ReusableConversionPage
      ...
      toUnit="Knots (kn)"
      convertFunction={(val) => val / 1.15078} // 1 mph ≈ 0.868976 kn
      definitions={definitions}
      tableComponent={<ConversionTable />} // Table for mph to knots
      conversionExample={
        <>
          ...
          <br />
          23.0156 ÷ 1.15078 = 20 kn
        </>
      }
      reversePath="/Converters/SpeedUnits/KnotToMph"
    />
  );
};
